...
public final class TestFileParagraphs {
    ...
    public static PageSource getContent() {
        var pages =  List.of(
                ...
                """
                        HEADER Text
                        vestibulum. Curabitur erat quam, vehicula eu nisl nec, dignissim consectetur libero. Etiam eget leo tortor.\s
