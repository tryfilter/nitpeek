 ...
 * how to use a {@link ServiceProviderPluginManager} and the {@link com.nitpeek.core.api.plugin.Plugin}s it provides.
 */
final class ServiceProviderPluginManagerWithDemoPluginShould {
    ...
    void enableGettingDefaultTranslatedFeatures() {
        ...
        var processor = processorForRuleSetWithId("com.nitpeek.demo.plugin1.MEANING_OF_LIFE");
    ...
    void useRuleSetDelete() {
        ...
        var processor = processorForRuleSetWithId("com.nitpeek.demo.plugin1.DELETION");
        processor.startProcessing(pages);
        var features = processor.getFeatures();
