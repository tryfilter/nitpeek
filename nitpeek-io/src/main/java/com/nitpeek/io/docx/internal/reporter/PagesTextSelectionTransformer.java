...
import com.nitpeek.io.docx.internal.common.*;
...
public final class PagesTextSelectionTransformer implements TextSelectionTransformer<SplittableRun> {
    ...
    private DocxTextSelection<SplittableRun> singleParagraphSelection(DocxParagraph<SplittableRun> paragraph, EdgeDetector.SelectionEdge first, EdgeDetector.SelectionEdge last) {
    ...
    private EdgeDetector.SelectionEdge computeFirstCharacterInFirstRun(TextSelection textSelection) {
        return computeCharacterAndRunCorrespondingTo(textSelection.fromInclusive());
    }

    private EdgeDetector.SelectionEdge computeLastCharacterInLastRun(TextSelection textSelection) {
        return computeCharacterAndRunCorrespondingTo(textSelection.toInclusive());
    }

    private EdgeDetector.SelectionEdge computeCharacterAndRunCorrespondingTo(TextCoordinate textCoordinate) {
