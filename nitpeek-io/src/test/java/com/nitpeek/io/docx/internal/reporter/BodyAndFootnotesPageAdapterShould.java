...
final class BodyAndFootnotesPageAdapterShould {
    private final CompositeRun headerRun1 = DocxTestUtil.run("Run numero uno");
    private final CompositeRun bodyRun1 = DocxTestUtil.run("Run numero dos");
    private final CompositeRun footnotesRun1 = DocxTestUtil.run("Run numero tres");
    private final CompositeRun footerRun1 = DocxTestUtil.complexRun("run 4 p1", "run 4 p2");
    private final CompositeRun headerRun2 = DocxTestUtil.complexRun("run 5 p1", "run 5 p2");
    private final CompositeRun bodyRun2 = DocxTestUtil.complexRun("run 6 p1", "run 6 p2");
    private final CompositeRun footnotesRun2 = DocxTestUtil.run("Run #7");
    private final CompositeRun footerRun2 = DocxTestUtil.run("Run #8");

    private final DocxPage<CompositeRun> page1 = DocxTestUtil.createPage(headerRun1, bodyRun1, footnotesRun1, footerRun1);
    private final DocxPage<CompositeRun> page2 = DocxTestUtil.createPage(headerRun2, bodyRun2, footnotesRun2, footerRun2);
    ...
    void returnBodyOnlyPages() {
        ...
        var bodyOnlyPages = List.of(
                DocxTestUtil.createPage(null, bodyRun1, null, null),
                DocxTestUtil.createPage(null, bodyRun2, null, null)
        );
    ...
    void returnFootnotesOnlyPages() {
        ...
        var footnotesOnlyPages = List.of(
                DocxTestUtil.createPage(null, null, footnotesRun1, null),
                DocxTestUtil.createPage(null, null, footnotesRun2, null)
        );
