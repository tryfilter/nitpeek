...
final class SplitRunShould {
    ...
    void setup() {
        ...
        R run = DocxTestUtil.createSampleRun(runText);
    ...
    void ignoreEmptyRuns() {
        ...
        var runWithEmptyText1 = DocxTestUtil.createSampleRun("");
        var runWithEmptyText2 = DocxTestUtil.createSampleRun("");
        var prefix = DocxTestUtil.createSampleRun(runText.substring(0, 5)); // ABCDE
        var middle1 = DocxTestUtil.createSampleRun(runText.substring(5, 6)); // F
        var middle2 = DocxTestUtil.createSampleRun(runText.substring(6, 16)); // GHIJKLMNOP
        var postFix = DocxTestUtil.createSampleRun(runText.substring(16)); // QRSTUVWXYZ
